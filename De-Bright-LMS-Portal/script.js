...
if(error){toast(‘Submission failed. Please try again.’,‘error’);return;}
...
if(error){toast(‘Failed to post notice.’,‘error’);return;}
...
if(error){toast(‘Failed to share resource.’,‘error’);return;}
...
if(error){toast(‘Failed to publish.’,‘error’);btn.innerHTML=’<i class="fas fa-paper-plane"></i> Publish to Class’;return;}
